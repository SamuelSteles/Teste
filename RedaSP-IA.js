...
const resposta = await fetch('https://api.openai.com/v1/chat/completions', {
        ...
        headers: { 
          ...
          "Authorization": "Bearer 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" // Substitua pela sua chave de API
        },
        body: JSON.stringify({
          model: "deepseek-chat",
          messages: [
